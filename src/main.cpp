...
int main() {
    try {
        ...
        LeitorConfiguracao leitor("entrada.txt");
        std::cout << "Arquivo de entrada lido com sucesso." << std::endl;
        ...
        std::cout << "Rede Logistica criada." << std::endl;
        ...
        std::cout << "Escalonador criado." << std::endl;
        ...
        std::cout << "Eventos de transporte iniciais agendados." << std::endl;
        ...
        std::cout << "\nMemoria dos pacotes liberada." << std::endl;
